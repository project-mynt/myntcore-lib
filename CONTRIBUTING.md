...
We're working hard to make *myntcore* the most powerful JavaScript library for working with Myntoin. Our goal is to have *myntcore* be a library that can be used by anyone interested in MMyntin, and to level expertise differences with great design and documentation.
...
```sh
git remote add silence48 git@github.com:silence48/myntcore.git
git pull --rebase silence48 master
```
