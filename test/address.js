...
var validbase58 = require('./data/myntd/base58_keys_valid.json');
var invalidbase58 = require('./data/myntd/base58_keys_invalid.json');
...
describe('Address', function() {
  ...
  describe('myntd compliance', function() {
  ...
  describe('encodings', function() {
    ...
    it('should error because of unrecognized data format', function() {
      ...
      }).should.throw(myntcore.errors.InvalidArgument);
    });
  ...
  describe('#object', function() {
    ...
    it('will fail with invalid state', function() {
      ...
      }).to.throw(myntcore.errors.InvalidState);
    });
  });
