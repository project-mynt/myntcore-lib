...
var JSUtil = myntcore.util.js;
var Interpreter = myntcore.Script.Interpreter;

var sig_canonical = require('../data/myntd/sig_canonical');
var sig_noncanonical = require('../data/myntd/sig_noncanonical');
...
describe('Signature', function() {
  ...
  describe('@isTxDER', function() {
    ...
    describe('myntd fixtures', function() {
