...
var HDPrivateKey = myntcore.HDPrivateKey;
var HDPublicKey = myntcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = myntcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(myntcore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(myntcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      myntcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = myntcore.PublicKey.fromPoint;
      myntcore.PublicKey.fromPoint = function() {
        myntcore.PublicKey.fromPoint = unstubbed;
