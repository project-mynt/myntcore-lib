...
describe('Transaction', function() {
  ...
  describe('checked serialize', function() {
    ...
    describe('skipping checks', function() {
      ...
      it('can skip the check that avoids spending more myntcoins than the inputs for a transaction', buildSkipTest(
        function(transaction) {
          return transaction
            .to(toAddress, 10000000000000)
            .change(changeAddress)
  ...
  describe('Segregated Witness', function() {
    ...
    describe('verifying', function() {
      ...
      describe('Myntcoin tests', function() {
        // from Myntoin tests at src/test/transaction_tests.cpp
